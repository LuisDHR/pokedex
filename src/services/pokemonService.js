...
// pokémones que se mostrarán en pantalla (dividido en decenas).
const pages = [
    { start: 1, end: 10 },
    { start: 11, end: 20 },
    { start: 21, end: 30 },
...
// Función para obtener los datos de un pokémones mediante su id.
export const getPokemonData = async (id) => {
    const res = await axios.get(`https://pokeapi.co/api/v2/pokemon/${id}`)
    return res
}

// Función para obtener una lista de 10 pokémones dependiendo del 
// numeró de página dado.
// Ejemplo: getPokemonList(10) devolverá una lista con los 
// pokémones que tienen identificadores del 1 al 10.
